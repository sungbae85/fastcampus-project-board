...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorkFine(){
        ...
        // When
        Article savedArticle = articleRepository.save(Article.of("new article", "new article content", "#spring"));
    ...
    void givenTestData_whenDeleting_thenWorkFine(){
        ...
        System.out.println(">>> previousArticleCount        " + previousArticleCount);
        System.out.println(">>> previousArticleCommentCount " + previousArticleCommentCount);
        ...
        // Then
        System.out.println(">>> " + (previousArticleCount - 1));
